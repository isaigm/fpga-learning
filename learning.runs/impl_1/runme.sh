...
HD_PWD='C:/Users/isaig/learning/learning.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sleep.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sleep.tcl -notrace
