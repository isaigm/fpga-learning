...
HD_PWD='C:/Users/isaig/learning/learning.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sleep.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sleep.tcl
